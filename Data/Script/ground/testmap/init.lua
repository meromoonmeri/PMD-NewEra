...
function testmap.See_Taken_Action(chara, activator)
        ...
        for i = 1, 8, 1 do
                UI:WaitShowDialogue("Mission " .. tostring(i) .. " : Client : " .. SV.TakenBoard[i].Client .. " Cible : " .. SV.TakenBoard[i].Target ..
                        " Zone : " .. SV.TakenBoard[i].Zone .. " Récompense : " .. SV.TakenBoard[i].Reward .. " Étage : " .. SV.TakenBoard[i].Floor .. " Type : "
                        .. SV.TakenBoard[i].Type .. " Achèvement : " .. SV.TakenBoard[i].Completion .. " Accepté : " .. tostring(SV.TakenBoard[i].Taken) .. " Difficulté : " .. SV.TakenBoard[i].Difficulty .. " Objet : " .. SV.TakenBoard[i].Item)                   
        end
...
function testmap.See_Mission_Action(chara, activator)
        ...
        UI:SetAutoFinish(true)
        for i = 1, 8, 1 do
                UI:WaitShowDialogue("Mission " .. tostring(i) .. " : Client : " .. SV.MissionBoard[i].Client .. " Cible : " .. SV.MissionBoard[i].Target ..
                        " Zone : " .. SV.MissionBoard[i].Zone .. " Récompense : " .. SV.MissionBoard[i].Reward .. " Étage : " .. SV.MissionBoard[i].Floor .. " Type : "
                        .. SV.MissionBoard[i].Type .. " Achèvement : " .. SV.MissionBoard[i].Completion .. " Accepté : " .. tostring(SV.MissionBoard[i].Taken) .. " Difficulté : " .. SV.MissionBoard[i].Difficulty .. " Objet : " .. SV.MissionBoard[i].Item)                 
        end
        UI:SetAutoFinish(false)
end
...
function testmap.See_Outlaw_Action(chara, activator)
        ...
        UI:SetAutoFinish(true)
        for i = 1, 8, 1 do
                UI:WaitShowDialogue("Mission " .. tostring(i) .. " : Client : " .. SV.OutlawBoard[i].Client .. " Cible : " .. SV.OutlawBoard[i].Target ..
                        " Zone : " .. SV.OutlawBoard[i].Zone .. " Récompense : " .. SV.OutlawBoard[i].Reward .. " Étage : " .. SV.OutlawBoard[i].Floor .. " Type : "
                        .. SV.OutlawBoard[i].Type .. " Achèvement : " .. SV.OutlawBoard[i].Completion .. " Accepté : " .. tostring(SV.OutlawBoard[i].Taken) .. " Difficulté : " .. SV.OutlawBoard[i].Difficulty ..  " Objet : " .. SV.OutlawBoard[i].Item)                     
        end
        UI:SetAutoFinish(false)
end
...
function testmap.CompleteTakens_Action()
        ...
        UI:WaitShowDialogue("Missions acceptées terminées !")
end 
