...
function metano_electric_home_ch_4.Luxray_Action(chara, activator)
        ...
        UI:WaitShowDialogue("Je suis déçu de lui.[pause=0] Il devrait être meilleur,[pause=10] mais son comportement et ses résultats médiocres ne me surprenent pas.")
