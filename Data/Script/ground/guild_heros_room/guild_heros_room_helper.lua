...
--if generic is false, just make the room look like it's night and put the duo in bed.
	...
	if generic then 
		...
		UI:WaitShowDialogue("La journée a été fatigante.[pause=0] On devrait se reposer pour pouvoir donner le meilleur de nous-même demain !")
		UI:WaitShowDialogue("D'accord,[pause=10] bonne nuit,[pause=10] " .. hero:GetDisplayName() .. ".")
		SOUND:FadeOutBGM(60)
...
function guild_heros_room_helper.Morning(generic)
	...
	if generic then 
		...
		UI:WaitShowDialogue("Bonjour les dormeurs ![pause=0] C'est un nouveau jour radieux !")
		GAME:FadeIn(40)
		GAME:WaitFrames(20)
