...
function metano_water_home_ch_2.Quagsire_Action(chara, activator)
        ...
        UI:WaitShowDialogue("Mes enfants...[pause=0] Ils sont adorables,[pause=10] mais ils ne sont pas très futés.")
        UI:WaitShowDialogue("Je me demande de qui ils tiennent ça ?")
...
function metano_water_home_ch_2.Floatzel_Action(chara, activator)
    ...
    local coro1 = TASK:BranchCoroutine(function() GROUND:CharTurnToCharAnimated(partner, chara, 4) end)
        ...
        UI:WaitShowDialogue("...Ooowwaaaa...[pause=0] Baissez le pont-levis...")

    TASK:JoinCoroutines({coro1})
        UI:WaitDialog()
        --todo: better sleeping onomatopoeia?
        UI:WaitShowDialogue("...Votre roi souhaite nager dans douat fossé royal...[pause=0] Fwwwwaaaahhhhh....")
