...
function metano_water_home_ch_4.Floatzel_Action(chara, activator)
        ...
        UI:WaitShowDialogue("Ensuite, je me rendrai pour toucher la prime qu'ils vont sûrement mettre sur ma tête !")
        UI:SetSpeakerEmotion("Joyous")
        GROUND:CharSetEmote(chara, "happy", 0)
        UI:WaitShowDialogue("Haha ![pause=0] Château de rêve,[pause=10] tu seras à moi !")
